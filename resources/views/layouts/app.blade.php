        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="pr-3"><a href="/profile">Manage Profile</a></li>
                    <li class="pr-3"><a href="/jobs">Our Jobs</a></li>
                    <li class="pr-3"><a href="/blog">Blog</a></li>
                    <li class="pr-3"><a href="/contact-form">Contact Us</a></li>
                </ul>
